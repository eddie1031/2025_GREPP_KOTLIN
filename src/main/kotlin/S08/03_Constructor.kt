...
fun main() {
    ...
    val carB = BClsCar("봉봉이", 15, true)
    val carC = CClsCar("뿡뿡이", 20, false)
...
class CoffeeOrderLv1(val name: String, var size: String, val extraShot: Boolean, val extraCream: Boolean) {
    ...
    init {
        ...
        println("""
            ...
            크림추가        : ${if (extraCream) "추가" else "추가 안함"}
            가격          : $price
        """.trimIndent())
...
class CoffeeOrderLv3(val name: String, var size: String, val extraShot: Boolean, val extraCream: Boolean) {
    ...
    init {
        ...
        if ( extraShot ) {
            price += 1000
            println("샷 추가하셔서 ${price}원 입니다!")
        } else {
            println("샷 추가 안하시면 ${price}원 입니다!")
        }
    ...
    init {
        ...
        if ( extraCream ) {
            price += 500
            println("크림 추가하셔서 ${price}원 입니다!")
        } else {
            println("크림 추가 안하시면 ${price}원 입니다!")
        }
